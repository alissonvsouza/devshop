...
CREATE TABLE IF NOT EXISTS `devshop`.`banners` (
  ...
  `url` VARCHAR(245) NULL,
  `order` INT NULL,
  `url_image` VARCHAR(245) NULL,
  `banners_type_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_banners_banners_types1_idx` (`banners_type_id` ASC),
  CONSTRAINT `fk_banners_banners_types1`
    FOREIGN KEY (`banners_type_id`)
